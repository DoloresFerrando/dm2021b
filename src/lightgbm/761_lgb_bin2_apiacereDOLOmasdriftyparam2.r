...
hs <- makeParamSet( 
         makeNumericParam("learning_rate",    lower=    0.015 , upper=    0.05),
         makeNumericParam("feature_fraction", lower=    0.1  , upper=    0.4),
         makeIntegerParam("min_data_in_leaf", lower= 900L   , upper= 6000L),
         makeIntegerParam("num_leaves",       lower=  100L   , upper= 1024L),
         makeNumericParam("prob_corte",       lower=    0.030, upper=    0.055)
        )
